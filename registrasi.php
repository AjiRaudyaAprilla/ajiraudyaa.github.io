	...
	if($exe->num_rows>0){
		...
		$insert="INSERT INTO warga (nik,nama,tgl_lahir,password,rt) VALUES ('$nik', '$nama', '$tgl_lahir', '$password', '$rt')";
					...
					<div class="row">
						...
						<div class="col-lg-7">
							<div class="p-5">
								...
								<a href="login.php"><button type = "submit" class="btn btn-success btn-user btn-block" > Sudah Registrasi ?</button> </a>
								<hr>
								<div class="text-center">
